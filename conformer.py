...
class Decoder(nn.Module):
    ...
    def forward(self, lde_c,lde_t):
        ...
        alpha=self.fc_layer(edge_rgbd.flatten(2))
        edge_rgbd=self.act(edge_rgbd)
        ...
        return edge_rgbd,alpha


class JL_DCF(nn.Module):
    def __init__(self,JLModule,lde_layers,decoder):
    ...
    def forward(self, f_all,f1_all):
        ...
        e_rgbd,alpha=self.decoder(lde_c,lde_t)
...
def build_model(network='conformer', base_model_cfg='conformer'):
        ...
        return JL_DCF(JLModule(backbone),LDELayer(),Decoder())
